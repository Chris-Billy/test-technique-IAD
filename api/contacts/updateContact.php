...
if (!empty($datas->id) && is_numeric($datas->id) && !empty($datas->last_name) && !empty($datas->first_name) && 
    !empty($datas->email) && !empty($datas->address) && !empty($datas->phone) && !empty($datas->age)) {
